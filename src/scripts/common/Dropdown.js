  ...
  class extends Input {
    ...
    extendConnectedCallback() {
      ...
      this.$input.addEventListener('keyup', (e) => {
        const event = new CustomEvent('phone.dropdowKeyDown', { detail: e.target.value })
    ...
    onSelect(item) {
      ...
      const event = new CustomEvent('dropdown.change', { detail: item });
...
window.customElements.define(
  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      document.addEventListener('phone.dropdowKeyDown', ({ detail: value }) => {
